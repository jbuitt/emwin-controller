...
class TestLogging extends Command
{
     ...
     * @var string
     */
    protected $signature = 'emwin-controller:test_logging {level}';
    ...
    public function handle()
    {
        ...
        print "  Host: " . config('emwin-controller.logging.host') . "\n";
        print "  Transport: " . config('emwin-controller.logging.transport') . "\n";
        print "  Port: " . config('emwin-controller.logging.port') . "\n";
        print "\n";
